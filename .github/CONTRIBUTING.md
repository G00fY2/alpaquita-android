...
Thank you for your interest in contributing! Since I maintain this Docker project alone in my free time, I appreciate your help. I only ask that you follow these simple guidelines to keep the image secure, fast, and maintainable.

---

## AI Usage Policy

I welcome AI as a productive tool, but I want to avoid unverified "AI slop" (low-effort, untested code). Therefore, the rules are simple:

- **Disclose AI usage:** If you used tools like GitHub Copilot, ChatGPT, or Claude, please state it in your Pull Request and briefly mention to what extent it helped you.
...
- **Review and edit text:** If you use AI to write issue descriptions or PR summaries, review and trim them. AI tends to be overly verbose. Low-effort spam or purely AI-generated text will be closed immediately.
...
* **Code Style:** All code, comments, and documentation must be strictly in **English**. Follow our `.editorconfig` for formatting, naming conventions, and line endings.

### Key Technical Rule for Docker Changes:
This image runs in restricted Kubernetes environments. Any directory or cache path you add **must follow the GID 0 strategy** (owned by the root group via `chgrp -R 0` with `chmod -R g=u`) and support arbitrary UIDs (`runAsNonRoot: true`).
...
* **Search first:** Please check existing Issues and Discussions to see if your topic has already been covered.
